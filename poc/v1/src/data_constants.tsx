...
export const FRIENDS_DATA: User[] = [
 ...
 { id: 'u3', name: 'Jordan', handle: '@jordy', avatarUrl: 'https://picsum.photos/600/600?u=3', color: '#EF4444', savedMomentsCount: 1 },
...
export const MOCK_SESSIONS: Session[] = [
 ...
 createSession('s2', 'u2', 'b1', 240, 600), // Ends 10h ago
 
 // 2. Lunch/Eating - 90m (1.5 hours)
 createSession('s3', 'u3', 'p2', 90, 480), // Ends 8h ago
